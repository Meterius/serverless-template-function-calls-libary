...
function insertAwsResourceNames(options) {
    ...
    if(isObject(root)){
        Object.keys(root).forEach((key) => {
            ...
            if(isObject(element)) {
                insertAwsResourceNames({ root: element, prefix });
                ...
                if (typeData) {
                    ...
                    element.Properties[nameProp] = element.Properties[nameProp] || name;
                }
                ...
                if(element.Type === "AWS::IAM::Role"){
                    if(isObject(element.Properties) && Array.isArray(element.Properties.Policies)){
                        ...
                        for(let i = 0; i < policies.length; i++){
                            policies[i].PolicyName = prefix + kebab(key) + "-inline-iam-policy-" + i;
                        }
                    }
                }
            }
...
module.exports = {
    ...
    replaceStrings, replaceValues, file, unpack
};
